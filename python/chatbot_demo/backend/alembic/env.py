...
from chat_service.db import Base

# Use the narrow DatabaseConfig rather than the full runtime Config — the
# migration container should not need the OPENAI_API_KEY env var just to run
...
def do_run_migrations(connection: Connection) -> None:
    """Execute migrations against a given synchronous connection.

    Configures the Alembic migration context with the connection and target metadata,
